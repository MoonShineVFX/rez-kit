...
def build(source_path, build_path, install_path, targets=None):
    ...
    settings_file = os.path.join(source_root, "SideFXLabs.json")
    if not os.path.isfile(settings_file):
        raise Exception("SideFXLabs package file not exists: %s"
                        % settings_file)
