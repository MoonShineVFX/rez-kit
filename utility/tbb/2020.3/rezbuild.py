...
if IS_WIN:
    url_prefix = "https://github.com/oneapi-src/oneTBB/releases/download/v2020.3"
    filename = "tbb-2020.3-win.zip"
else:
    url_prefix = "https://github.com/oneapi-src/oneTBB/archive"
    filename = "v2020.3.tar.gz"
...
def lnx_mac_build(source, install):
    if IS_MAC:
        # Note: (v2017_U6) TBB installation fails on OSX when cuda is installed, a
        # suggested fix:
